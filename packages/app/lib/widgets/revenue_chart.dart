...
class RevenueChart extends StatelessWidget {
                          ...
                          getTitlesWidget: (value, meta) {
                             ...
                             return Padding(
                               ...
                               child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 10,
                                    color: isSelected ? AppTheme.primary : theme.iconTheme.color,
  ...
  BarChartGroupData _makeBarGroup(int x, double y, bool isSelected, ThemeData theme) {
    return BarChartGroupData(
      x: x,
      barRods: [
        BarChartRodData(
          toY: y,
          color: isSelected ? AppTheme.primary : theme.iconTheme.color?.withOpacity(0.2) ?? Colors.grey,
          width: 6,
          borderRadius: BorderRadius.circular(4),
