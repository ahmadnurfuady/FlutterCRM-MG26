              ...
              child: ListView(
                ...
                children: [
                   ...
                   Container(
                     ...
                     child: Row(
                       children: [
                         Container(
                           padding: const EdgeInsets.all(8),
                           child: const Icon(Icons.add_task, color: AppTheme.primary),
                         ),
                         Expanded(
                           child: TextField(
                   ...
                   const TaskCard(
                     ...
                     status: TaskStatus.overdue,
                     avatarUrl: null, // No avatar shown in second card of overdue
                   ),
                   ...
                   const TaskCard(
                     ...
                     avatarUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBun-NPsSo0EcHUseLhSCVUUXyCLXJEKTVh7eUAo4bK6IBMignPITQH0eVSB1fAHvBtRYVLeloGU1Xx3xEdZcFWkfRa1WXhiDtYidszD8PlSaOxwNIXYZeB2qwyGQ-rUaLp4sTvhU7--Fkbh2zOahZvMhhwa3GK_KgxOau3MenpTCuauvioX5rJQYPCWJc85yq5g8wAj-q6TPb3Hr3of5vSwVleAz36gM2hgav_4-_BkqekvUbj0yFNdWNFVsi0cTl7yL4hs_dQzc8',
                   ),
                   const TaskCard(
                     ...
                     child: Column(
                       children: [
                         ...
                         const TaskCard(
                           ...
                           assignee: '', // Not needed for completed style in this specific design
                           timeLabel: '9:00 AM',
